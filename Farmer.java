...
public class Farmer extends JApplet implements MouseListener, KeyListener
{ 
  ...
  /* This repaint function repaints only the parts of the screen that may have changed.
     Namely the area around every player dog and the menu bars
  */
  public void repaint()
  {
    ...
    b.repaint(b.dog1.x-20,b.dog1.y-20,80,80);
    b.repaint(b.dog2.x-20,b.dog2.y-20,80,80);
    b.repaint(b.dog3.x-20,b.dog3.y-20,80,80);
    b.repaint(b.dog4.x-20,b.dog4.y-20,80,80);
  }
